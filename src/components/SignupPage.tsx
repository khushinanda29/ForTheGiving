        ...
        {!showSuccess ? (
          <>
            <div className="flex flex-col items-center mb-8">
              <Logo className="mb-4" />
              <p className="text-[#333333] opacity-60">Create your account</p>
            </div>
            ...
            <form onSubmit={handleSignup} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={role} onValueChange={(val) => setRole(val as "donor" | "hospital")}>
                  <SelectTrigger id="role">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="donor">Donor</SelectItem>
                    <SelectItem value="hospital">Hospital / Donation Center</SelectItem>
                  </SelectContent>
                </Select>
              </div>
          ...
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-[#333333]">Account created successfully!</p>
